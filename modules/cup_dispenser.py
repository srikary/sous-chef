...
class CupDispenser:
  ...
  def __init__(self,
    ...
    self.large_cup1_servo = Servo(large_cup1_servo_channel, CupDispenser.cup_positions[2][0], move_delay=0.005)
    self.large_cup2_servo = Servo(large_cup2_servo_channel, CupDispenser.cup_positions[3][0], move_delay=0.007)
    self.reset()
