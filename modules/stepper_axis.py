...
class StepperAxis:
  rotations_per_mm = 0.5  # TODO: Set this right.
  """ Represents an axis controlled by a stepper motor """
  def __init__(self, dir_pin, step_pin, max_translation_mm, speed=60, inc_clockwise=True):
  ...
  def increment_pos_by_mm(self, distance_in_mm):
    ...
    num_rotations = distance_in_mm * rotations_per_mm
